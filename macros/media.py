...
app = {               # REQUIRED dict, must be named 'app'
    ...
    'macros' : [      # List of button macros...
        ...
        (0xFFFFFF, 'Bright+', [[ConsumerControlCode.BRIGHTNESS_INCREMENT]]),
        # 2nd row ----------
        (0xFFFFFF, '', []),
        (0xFFFFFF, 'Vol-', [[ConsumerControlCode.VOLUME_DECREMENT]]),
        (0xFFFFFF, 'Bright-', [[ConsumerControlCode.BRIGHTNESS_DECREMENT]]),
        # 3rd row ----------
        (0xFFFFFF, '', []),
        (0xFFFFFF, 'Mute', [[ConsumerControlCode.MUTE]]),
        (0xFFFFFF, '', []),
        # 4th row ----------
        (0xFFFFFF, '<<', [[ConsumerControlCode.SCAN_PREVIOUS_TRACK]]),
        (0xFFFFFF, 'Play/Pause', [[ConsumerControlCode.PLAY_PAUSE]]),
        (0xFFFFFF, '>>', [[ConsumerControlCode.SCAN_NEXT_TRACK]]),
        # Encoder button ---
        (0xFFFFFF, '', [])
    ]
}
